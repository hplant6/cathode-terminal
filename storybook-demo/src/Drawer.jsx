...
.sb-drawer > summary::before { content: '▸'; color: var(--spec-text-faint); transition: transform 0.12s, color 0.12s; display: inline-block; }
.sb-drawer[open] > summary::before { transform: rotate(90deg); }
.sb-drawer > summary:hover { color: var(--spec-text); }
.sb-drawer > summary:hover::before { color: var(--spec-accent); }     /* orange chevron on hover */
.sb-drawer > pre {
