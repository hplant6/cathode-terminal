...
function projectBlock(dir) {
  ...
  lines.push('This block is regenerated by Cathode each session — treat it as the source of truth for this project; editing it here has no lasting effect.', PJ_END);
  return lines.join('\n');
}
